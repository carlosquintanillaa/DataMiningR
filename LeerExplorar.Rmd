---
title: "Tutorial R: Leer Datos CSV y Explorarlos. Parte 1"
...
Cargar library **ggplot2** necesaria para hacer todos los graficos en este tutorial. Si el library no esta disponible puede instalarse usando **install.packages("ggplot2")**
