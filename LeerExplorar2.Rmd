---
title: "Tutorial R: Leer Datos CSV y Explorarlos. Parte 2."
...
qplot(Neighborhood,SqFt,data=houses,geom="boxplot")
qplot(Neighborhood,SqFt,data=houses,geom="boxplot",fill=Neighborhood)
```
...
qplot(Neighborhood,SqFt,data=houses,geom="violin")
qplot(Neighborhood,SqFt,data=houses,geom="violin",fill=Neighborhood)
```
